    ...
    useTranslation: () => ({
      t: (key: string, options?: TranslationOptions) => {
        const map: Record<string, TranslationValue> = {
          ...
          "history.actions.create": "I18N_History_Action_Create",
          "history.actions.edit": "I18N_History_Action_Edit",
          "history.actions.delete": "I18N_History_Action_Delete",
          "history.actions.cancel": "I18N_History_Action_Cancel",
          "history.actions.save": "I18N_History_Action_Save",
          "history.actions.saving": "I18N_History_Action_Saving",
          "history.actions.submit": "I18N_History_Action_Submit",
