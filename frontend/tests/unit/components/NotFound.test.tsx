...
describe("NotFound", () => {
  beforeEach(() => {
    renderWithRouterAndTheme({ useRealNotFound: true, initialPath: "/non-existent-route" });
  });
  ...
  it("renders navigation buttons", () => {
    expect(screen.getByRole("link", { name: "I18N_NotFound_Button_Explore" })).toBeInTheDocument();
    expect(screen.getByRole("link", { name: "I18N_NotFound_Button_History" })).toBeInTheDocument();
  });
});