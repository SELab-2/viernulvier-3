...
## Beslissing
We gebruiken **React** als frontend framework.  
...
- Developers kunnen redelijk snel features bouwen.  
- Eventuele toekomstige upgrades kunnen eenvoudig doorgevoerd worden.